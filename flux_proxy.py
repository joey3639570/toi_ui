...
# Update the API URL to match your BentoML service
API_URL = 'https://cloudinfra-services.ubilink.ai/f03b5d13-c6d3-435d-9278-a5929bf9ac69/bento/txt2img'  # 請根據實際的 BentoML 服務地址修改
...
if __name__ == '__main__':
    logger.info("Starting FLUX proxy server on port 5000...")
